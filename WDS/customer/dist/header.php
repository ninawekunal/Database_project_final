...
<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <h5 style="color:white;margin-left: 20px;margin-top: 3px;">Your Menu:</h5>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <a class="nav-link collapsed" href="current_auto_ins.php"><i class="fas fa-car"></i> &nbsp;Auto Insurance</a>
                                <a class="nav-link collapsed" href="home_ins_houses.php"><i class="fas fa-home"></i> &nbsp;Home Insurance</a>
                            </div>
